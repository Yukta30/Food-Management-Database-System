...
def DisplayForm():
    ...
    display_screen.title("FOOD MANAGEMENT SYSTEM")
    global tree
    global SEARCH
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="Food Management System", font=('verdana', 18), width=600,bg="#1C2833",fg="white")
    lbl_text.pack(fill=X)
    #creating registration form in first left frame
    Label(LFrom, text="Customer Name ", font=("Arial", 12)).pack(side=TOP)
    ...
    Label(LFrom, text="Item Name ", font=("Arial", 12)).pack(side=TOP)
    Entry(LFrom, font=("Arial", 10, "bold"),textvariable=rollno).pack(side=TOP, padx=10, fill=X)
    Label(LFrom, text="order no. ", font=("Arial", 12)).pack(side=TOP)
    ...
    lbl_txtsearch = Label(LeftViewForm, text="Enter Name of customer.", font=('verdana', 10),bg="gray")
    lbl_txtsearch.pack()
   ...
   #setting scrollbar
    ...
    tree = ttk.Treeview(MidViewForm,columns=("Id", "Name", "Contact", "Address","item name","order id"),
...
def register():
    ...
    if name1=='' or con1==''or email1=='' or rol1==''or branch1=='':
        ...
        #execute query
        conn.execute('INSERT INTO STUD_REGISTRATION (STU_NAME,STU_CONTACT,STU_ADDRESS,STU_item,STU_ID) \
